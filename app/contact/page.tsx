...
export const metadata: Metadata = {
  title: 'Contact & Free Manuscript Consultation | Royal Quil Publisher',
  description: 'Schedule a complimentary manuscript evaluation and publishing consultation with a senior editor at Royal Quil Publisher. 100% author rights and confidentiality guaranteed.',
};
