...
export const metadata: Metadata = {
  title: 'Global Publishing & Distribution | Royal Quil Publisher',
  description: 'Learn how Royal Quil Publisher connects your title to Amazon KDP, Apple Books, Kobo, Barnes & Noble, and Ingram Content Group while you retain 100% rights, ownership, and royalties.',
};
            ...
            <table className={styles.comparisonTable}>
              <thead>
                <tr>
                  ...
                  <th className={styles.highlightHeader}>Royal Quil Publisher</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        <div className={styles.container}>
          <div className={styles.isbnGrid}>
            <div className={styles.isbnTextCol}>
              ...
              <p className={styles.isbnBody}>
                At Royal Quil Publisher, we register all ISBNs directly under your name or your private imprint through official national agencies (Nielsen in the UK, Bowker in the US). You own your book&apos;s legal identity permanently.
              </p>
            </div>
