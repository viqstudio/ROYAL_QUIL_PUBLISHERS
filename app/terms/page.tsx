...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Royal Quill Publisher',
  description: 'Terms and Conditions and Author Autonomy Charter for Royal Quill Publisher.',
};
      ...
      <div className={styles.container}>
        <div className={styles.paperCard}>
          ...
          <div className={styles.content}>
            <p>
              Welcome to Royal Quill Publisher. By accessing our website or engaging our book production and publishing services, you agree to these Terms & Conditions.
            </p>

            <div className={styles.highlightPledge}>
              The 100% Author Autonomy Guarantee: Royal Quill Publisher operates strictly as a service and production partner. The author retains 100% of all copyright, trademark rights, subsidiary rights, and sales royalties permanently.
            </div>

            <h2>1. Author Intellectual Property Rights</h2>
            <p>
              Under no circumstances does Royal Quill Publisher claim or acquire any ownership interest, copyright assignment, or future equity in any manuscript, title, character, or creative work submitted or produced through our services.
            </p>
            <p>
            ...
            <p>
              Royal Quill Publisher does not act as a financial intermediary for your book sales. Distribution channels (including Amazon KDP, Apple Books, Kobo, and Ingram) are configured so that all ongoing net royalty payments deposit directly into the author&apos;s designated bank account.
            </p>
