        ...
        <div className={styles.heroContainer}>
          <div className={styles.heroContent}>
            <div className={styles.heroEyebrow}>
              ...
              <span>ROYAL QUILL PUBLISHERS • ESTABLISHED 5+ YEARS</span>
            </div>
            ...
            <p className={styles.heroDescription}>
              Royal Quill Publishers helps independent authors transform ideas and manuscripts into professionally written, edited, designed, and published books — while keeping full ownership of their work.
            </p>
        ...
        <div className={styles.siteContainer}>
          <div className={styles.trustHeader}>
            ...
            <p className={styles.trustSub}>
              Royal Quill Publishers provides the literary expertise and production infrastructure required to professionally prepare and publish your book, while you retain 100% legal ownership of your intellectual property.
            </p>
          </div>
      ...
      <section id="services" className={styles.servicesSection}>
        <div className={styles.siteContainer}>
          <SectionHeading
            ...
            subtitle="From the first outline to global retail distribution, Royal Quill Publishers unites writing, editorial, design, and marketing into one seamless partnership."
          />
          ...
          <div className={styles.whyHeroBlock}>
            <div className={styles.whyHeaderCol}>
              ...
              <p className={styles.whyMainSub}>
                Traditional publishers demand all intellectual rights and pay minor royalties. Low-end services deliver generic template designs. Royal Quill Publishers delivers the craftsmanship of a premier imprint while leaving you in full ownership.
              </p>
        ...
        <div className={styles.siteContainer}>
          <div className={styles.aboutGrid}>
            <div className={styles.aboutTextCol}>
              <span className={styles.aboutEyebrow}>ABOUT ROYAL QUILL PUBLISHERS</span>
              <h2 className={styles.aboutTitle}>
                Publishing Should Feel Like a Partnership.
              </h2>
              <p className={styles.aboutLead}>
                Royal Quill Publishers was founded on a singular conviction: that serious authors deserve the craftsmanship and commercial reach of a major publishing house without surrendering their intellectual rights or creative voice.
              </p>
